...
import { SeatsComponent, PaymentNoticeComponent } from './features/booking/seats.component';
...
export const routes: Routes = [
  ...
  { path: 'payment', component: PaymentNoticeComponent, canActivate: [authGuard], title: 'Payment | BookMyShow' },
  { path: '**', redirectTo: '' }
];
